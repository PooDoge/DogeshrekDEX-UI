...
import { Currency, currencyEquals, CAVAX, TokenAmount, WAVAX } from '@baguette-exchange/sdk'
...
export default function AddLiquidity({
  ...
  const [approvalA, approveACallback] = useApproveCallback(parsedAmounts[Field.CURRENCY_A], chainId ? ROUTER_ADDRESS[chainId] : ROUTER_ADDRESS[ChainId.DOGECHAIN])
  const [approvalB, approveBCallback] = useApproveCallback(parsedAmounts[Field.CURRENCY_B], chainId ? ROUTER_ADDRESS[chainId] : ROUTER_ADDRESS[ChainId.DOGECHAIN])
