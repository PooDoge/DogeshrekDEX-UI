      ...
      <TopSection gap="md">
        <DataCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Lock LP tokens to earn swampy Doge</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  Deposit your DogeShrek-lp tokens to receive DogeShrek.
                 <br/> Warning: always remember <a target="_BLANK" href="https://academy.binance.com/en/articles/impermanent-loss-explained">impermanent loss</a> does exist
                 <br/> Beta Lp Staking: Use at your own risk.
