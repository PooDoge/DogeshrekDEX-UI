...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
	...
	const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
		() => [
			...
			[wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.DOGECHAIN ? USDC : undefined],
			[chainId ? WAVAX[chainId] : undefined, chainId === ChainId.DOGECHAIN ? USDC : undefined]
		],
