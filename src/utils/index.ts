...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, CAVAX } from '@baguette-exchange/sdk'
...
export function getRouterContract(chainId: ChainId, library: Web3Provider, account?: string): Contract {
  return getContract(chainId ? ROUTER_ADDRESS[chainId] : ROUTER_ADDRESS[ChainId.DOGECHAIN], IBaguetteRouterABI, library, account)
}
